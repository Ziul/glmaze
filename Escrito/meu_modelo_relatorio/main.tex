...
Z,JNC,JLO,JC,JHS,JN,JGE,JL,JMP,NOP,POP,BR,LD
...
\vfill %Force to get in the end of a page
\begin{multicols}{3}
	...
	\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{./fts/gust}}]{\gust}\label{gustbio}
	...
	\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{./fts/fay}}]{\fay}\label{faybio}
