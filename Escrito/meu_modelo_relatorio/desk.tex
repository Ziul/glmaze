...
\end{tikzpicture}
%\caption{Diagrama de dependências simplificado}
%\end{figure}
%\begin{multicols}{2}

Com base nas dependências de cada sistema operacional, foi montado então o \textit{header} da seguinte forma:
